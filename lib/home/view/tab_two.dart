...
class _TabTwoState extends State<TabTwo>
  ...
  late TextEditingController c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12;
                      ...
                      Expanded(
                        ...
                        child: TextFormField(
                          ...
                          controller: c12 = TextEditingController()
                            ..text = state.totalUndividedLand.value ?? ''
                            ..selection = TextSelection.fromPosition(
                              TextPosition(
                                offset: state.totalUndividedLand.value == null
                                    ? 0
                                    : c12.selection.base.offset >
                                            state
                                                .totalUndividedLand.value.length
                                        ? state.totalUndividedLand.value.length
                                        : c12.selection.base.offset,
                              ),
                            ),
                          maxLines: 1,
                          ...
                          key: const Key('sectionTwo_totalUndividedLand'),
                          onChanged: (value) => context
                              .read<SectionTwoCubit>()
                              .totalUndividedLandChanged(value),
                          obscureText: false,
                          decoration: InputDecoration(
                            prefixIcon: const Padding(
                              padding: EdgeInsets.only(
                            ...
                            border: const OutlineInputBorder(),
                            labelText:
                                "Total land owned by the undivided family ?",
                            helperText: '',
                            errorText: state.totalUndividedLand.invalid
                                ? 'required field'
                                : null,
                          ),
                        ),
                      ...
                      Expanded(
                        ...
                        child: TextFormField(
                          ...
                          controller: TextEditingController(
                            text: getArea(state.totalUndividedLand.value),
                          ),
                          decoration: InputDecoration(
                            filled: true,
                    ...
                    child: TextFormField(
                      ...
                      controller: c1 = TextEditingController()
                        ...
                        ..selection = TextSelection.fromPosition(
                          TextPosition(
                            offset:
                                c1.selection.base.offset > state.yesName.length
                      ...
                      onChanged: (value) =>
                          context.read<SectionTwoCubit>().yesNameChanged(value),
                      obscureText: false,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) =>
                          context.read<SectionTwoCubit>().noNameChanged(value),
                      obscureText: false,
                      decoration: const InputDecoration(
                        prefixIcon: Padding(
                          padding: EdgeInsets.only(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        helperText: '',
                        errorText:
                            state.countChulha.invalid ? 'required field' : null,
                      ),
                    ),
                  ),
                ),
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        helperText: '',
                        errorText:
                            state.totalPeople.invalid ? 'required field' : null,
                      ),
                    ),
                  ),
                ),
