...
class _TabFiveState extends State<TabFive>
  ...
  late TextEditingController c1, c2, c3, c4, c5, c6, c7, c8, c9, c10;
                      ...
                      Expanded(
                        ...
                        child: TextFormField(
                          ...
                          controller: c10 = TextEditingController()
                            ..text = state.totalLandToLoose.value ?? ''
                            ..selection = TextSelection.fromPosition(
                              TextPosition(
                                offset: state.totalLandToLoose.value == null
                                    ? 0
                                    : c10.selection.base.offset >
                                            state.totalLandToLoose.value.length
                                        ? state.totalLandToLoose.value.length
                                        : c10.selection.base.offset,
                              ),
                            ),
                          ...
                          key: const Key('sectionFive_totalLandToLoose'),
                          onChanged: (value) => context
                              .read<SectionFiveCubit>()
                              .totalLandToLooseChanged(value),
                          obscureText: false,
                          decoration: const InputDecoration(
                            ...
                            labelText:
                                "Total land you will lose in land acquisition ?",
                            helperText: '',
                          ),
                        ),
                      ),
                      ...
                      Expanded(
                        ...
                        child: TextFormField(
                          ...
                          controller: TextEditingController(
                            text: getArea(state.totalLandToLoose.value),
                          ),
                          decoration: InputDecoration(
                            filled: true,
                              ...
                              TextPosition(
                                offset: state.landHoldingLost['berna'] == null
                                    ...
                                    : c3.selection.base.offset >
                                        ...
                                        ? state.landHoldingLost['berna'].length
                                        : c3.selection.base.offset,
                              ),
                            ),
                          maxLines: 1,
                              ...
                              TextPosition(
                                offset: state.landHoldingLost['bahal'] == null
                                    ...
                                    : c4.selection.base.offset >
                                        ...
                                        ? state.landHoldingLost['bahal'].length
                                        : c4.selection.base.offset,
                              ),
                            ),
                          maxLines: 1,
                        ...
                        child: TextFormField(
                          ...
                          controller: c5 = TextEditingController()
                            ...
                            ..selection = TextSelection.fromPosition(
                              TextPosition(
                                offset:
                                    state.landHoldingLost['gharBari'] == null
                                        ? 0
                                        : c5.selection.base.offset >
                                                state
                                                    .landHoldingLost['gharBari']
                                                    .length
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) =>
                          context.read<SectionFiveCubit>().reasonChanged(value),
                      obscureText: false,
                      decoration: const InputDecoration(
                        prefixIcon: Padding(
                          padding: EdgeInsets.only(
                  ...
                  child: Padding(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        ...
                        helperText: '',
                        errorText:
                            state.participate.invalid ? 'required field' : null,
                      ),
                      items: yesNoList
                          .map<DropdownMenuItem<String>>((String value) {
                        return DropdownMenuItem<String>(
